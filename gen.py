...
rodzaj_uslugi: Typ usługi używanej przez użytkownika (1 - podstawowa, 2 - premium, 3 - VIP).
czas_subskrypcji: Czas trwania subskrypcji w miesiącach.
czas_na_platformie: Łączny czas spędzony na platformie w godzinach.
liczba_reklamacji: Liczba reklamacji zgłoszonych przez użytkownika.
srednia_transakcji: Średnia liczba transakcji miesięcznych.
srednie_wydatki: Średnie miesięczne wydatki użytkownika w jednostkach walutowych.
zalegle_platnosci: Liczba zaległych płatności użytkownika.
